...
from models.StableDiffusion.ldm.modules.diffusionmodules.util import (
    checkpoint,
    conv_nd,
    linear,
    avg_pool_nd,
...
from models.StableDiffusion.ldm.modules.attention import (
    default,
    exists,
    CrossAttention,
)
...
class QuantBasicTransformerBlock(BaseQuantBlock):
    def __init__(self, basictransformerblock: BasicTransformerBlock, weight_quant_params: dict = {}, act_quant_params: dict = {}):
        ...
        # 量化模块调量化模块的传入参数 TODO
        self.quant_attn1 = QuantCrossAttention(CrossAttention, weight_quant_params, act_quant_params)
